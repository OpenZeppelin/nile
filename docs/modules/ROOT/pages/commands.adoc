...
[.contract-item]
[[deploy]]
==== `[.contract-item-name]#++nile deploy <PRIVATE_KEY_ALIAS> <CONTRACT>++#`
...
[.contract-item]
[[call]]
==== `[.contract-item-name]#++nile call <CONTRACT_ID> <METHOD>++#`
...
[.contract-item]
[[send]]
==== `[.contract-item-name]#++nile send <PRIVATE_KEY_ALIAS> <CONTRACT_ID> <METHOD>++#`
...
Deletes the *artifacts/* folder and deployment files.
