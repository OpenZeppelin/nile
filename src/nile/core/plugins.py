...
def get_installed_plugins(scope="cli") -> Dict:
    """
    Get the name and object of installed Nile plugins.

    @param scope: can be either cli or nre.
...
def load_plugins(app) -> Group:
    ...
    @param app: (click.group) main cli app.
    @returns click app with plugins commands added.
    """
