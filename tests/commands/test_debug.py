...
@patch("nile.core.commands.debug._abi_to_build_path", return_value=ABI_PATH)
def test__locate_error_lines_with_abis_with_and_without_alias(
    mock_path, file, address_set
):
    with patch("nile.core.commands.debug.open") as mock_open:
...
@patch("nile.core.commands.debug.json.loads")
